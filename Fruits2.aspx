<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Fruits2.aspx.cs" Inherits="Fruits2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="style4">
                ...
                <tr>
                    <td class="style5">
                        ...
                        .<strong><span class="style6">00</span></strong> Rs.(<asp:Label ID="Label2" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Fruit" Name="category" Type="String" />
        </SelectParameters>
        </asp:SqlDataSource>
</p>
<p>
