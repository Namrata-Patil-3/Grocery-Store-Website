<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Staples.aspx.cs" Inherits="Staples" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table class="style4">
                ...
                <tr>
                    <td class="style5">
                        ...
                        <span class="style9"><strong>.00</strong></span> Rs.(<asp:Label ID="Label2" runat="server" style="font-size: medium" 
                            Text='<%# Eval("quantity") %>'></asp:Label>
                        )&nbsp;&nbsp;&nbsp;&nbsp; <span class="style9">Quantity<asp:DropDownList ID="DropDownList1" 
                            runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Staples" Name="category" Type="String" />
        </SelectParameters>
        </asp:SqlDataSource>
</p>
<p>
