...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" 
        ...
        <EditItemTemplate>
            <table class="style4">
                <tr>
                    <td class="style8">
                        <asp:Image ID="Image1" runat="server" BackColor="White" BorderStyle="Groove" 
                            Height="233px" ImageUrl='<%# Eval("productpic") %>' style="font-size: small" 
                            Width="320px" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="style6">
                        ...
                        <asp:Label ID="Label1" runat="server" 
                            style="font-weight: 700; font-size: x-large; text-align: left;" 
                ...
                <tr>
                    <td class="style6">
                        ...
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("name") %>' 
                            style="font-weight: 700; font-size: x-large; text-align: left;"></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    <td class="style5">
                        ...
                        <asp:Label ID="Label3" runat="server" 
                            style="font-weight: 700; font-size: medium" Text='<%# Eval("price") %>'></asp:Label>
                        <strong><span class="style9">.00</span></strong> Rs.&nbsp;(<asp:Label ID="Label2" runat="server" Text='<%# Eval("quantity") %>'></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Beauty" Name="category" Type="String" />
        </SelectParameters>
        </asp:SqlDataSource>
</p>
<p>
